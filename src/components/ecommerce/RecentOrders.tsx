                        ...
                        {key === "symbol" ? (
                          <div className="flex items-center gap-2">
                            <div className="relative w-6 h-4">
                              <div className="absolute left-0 top-0 h-4 w-4 bg-gray-200 rounded-full animate-pulse"></div>
                              <div className="absolute left-[-35%] top-[-50%] h-4 w-4 bg-gray-200 rounded-full animate-pulse"></div>
                            </div>
