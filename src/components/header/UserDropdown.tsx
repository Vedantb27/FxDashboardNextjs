  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <IconUser stroke={3} className="mt-2.5"/>
        </span>

        <span className="block mr-1 font-medium text-theme-sm"> { authData?.user?.firstName}</span>
      ...
      >
        ...
        <Link
          href="/signin"
          onClick={()=>{sessionStorage.removeItem(AUTH_STORAGE_KEY)}}
